...
<head>
  <link rel="stylesheet" href="../css/rotate.css" type="text/css" media="screen" />  
  <script src='../jQuery/jquery.js'></script>
  <script src='../jQuery/jquery.keyframes.js'></script>
  <script src='../jQuery/jquery.keyframes.min.js'></script>
  <script src='../jQuery/svg.js'></script>
  <script src='../jQuery/svg.filter.js'></script>
  <script src='../jQuery/loops.js'></script>
  <script src='../jQuery/createLSVG.js'></script>
...
<body style='overflow-x: hidden; overflow-y: hidden;'>
????  good?
<div id="divSVG" style='opacity: 1; position: absolute; width: 100%; height: 100%; top: 0px; left: 0px;' >
    <svg id="bodySVG" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid meet" viewBox="0 0 100 100" width="100%" height="100%" style=" position: relative; top: 0px; left: 0px;" >
    </svg>
    ?'??
</div>
